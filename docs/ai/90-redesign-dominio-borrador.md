...
- ⏭️ **Pendiente (tangled, cabeza fresca)**: `finanzas` (mismo patrón + área sensible: SELECTs líneas 94/157/272/383/505, JSON 413/543, ORDER, WHERE). Requiere flipear los SELECT-return a `se.fecha_inicio AS semana_inicio` cuidando el contrato de respuesta.
