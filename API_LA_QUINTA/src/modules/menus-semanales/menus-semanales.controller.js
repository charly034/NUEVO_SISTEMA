...
export const deleteMenuSemanal = asyncHandler(async (req, res) => {
  await service.deleteMenuSemanal(req.params.id);
  sendNoContent(res);
});
...
export const agregarPlatoDia = asyncHandler(async (req, res) => {
  const resultado = await service.agregarPlatoDia(req.params.id, req.body);
...
export const quitarPlatoDia = asyncHandler(async (req, res) => {
  await service.quitarPlatoDia(req.params.id, req.params.dia, req.params.opcion);
  sendNoContent(res);
});
...
export const marcarSinServicio = asyncHandler(async (req, res) => {
  const resultado = await service.marcarSinServicio(req.params.id, req.body);
...
export const quitarSinServicio = asyncHandler(async (req, res) => {
  await service.quitarSinServicio(req.params.id, req.params.dia);
  sendNoContent(res);
});
...
export const cambiarEstadoMenu = asyncHandler(async (req, res) => {
  const menu = await service.cambiarEstadoMenu(req.params.id, req.body.estado, req.body);
